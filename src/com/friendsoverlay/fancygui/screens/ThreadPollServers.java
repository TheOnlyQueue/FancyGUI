...
class ThreadPollServers extends Thread
{
	...
	final GuiFancySlotServer serverSlotContainer;

	ThreadPollServers(GuiFancySlotServer par1GuiSlotServer, ServerData par2ServerData)
	{
					...
					label186:
					{
						label187:
						{
							try
							{
								...
								GuiFancyMultiplayer.func_82291_a(this.pollServersServerData);
							...
							finally
							{
								if (var27)
								{
									...
									{
										GuiFancyMultiplayer.decreaseThreadsPending();
									}
								}
							}
