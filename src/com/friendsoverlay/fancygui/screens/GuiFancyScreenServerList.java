...
public class GuiFancyScreenServerList extends GuiFancyScreen {
	...
	public GuiFancyScreenServerList(GuiScreen par1GuiScreen, ServerData par2ServerData)
	{
	...
	public void initGui()
	{
		...
		this.buttonList.add(new GuiFancyButton(0, this.width / 2, this.height / 4 + 96 + 12, var1.translateKey("selectServer.select"), 3));
