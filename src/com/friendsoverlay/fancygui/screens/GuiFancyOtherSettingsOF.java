...
public class GuiFancyOtherSettingsOF extends GuiFancyScreen {
	...
	public GuiFancyOtherSettingsOF(Minecraft mc, GuiScreen oldScreen) {
		super(mc, oldScreen);
	...
	public void initGui()
	{
		...
		for (int var5 = 0; var5 < var4; ++var5)
		{
			...
			{
				this.buttonList.add(new GuiFancySmallButton(var6.returnEnumOrdinal(), var7 + 75, var8, var6, this.settings.getKeyBinding(var6), 3));
			}
			else
			{
		...
		this.buttonList.add(new GuiFancyButton(210, this.width / 2, this.height / 6 + 168 + 11 - 22, "Reset Video Settings...", 3));
