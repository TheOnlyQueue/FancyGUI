...
public class GuiFancyFlatPresets extends GuiFancyScreen {
    ...
    private GuiFancyCreateFlatWorld createFlatWorldGui;
    private String field_82300_d;
    private String field_82308_m;
    private String field_82306_n;
    private GuiFancyFlatPresetsListSlot theFlatPresetsListSlot;
    ...
    static GuiFancyFlatPresetsListSlot func_82292_a(GuiFancyFlatPresets par0GuiFlatPresets)
    {
        return par0GuiFlatPresets.theFlatPresetsListSlot;
    }

    static GuiTextField func_82298_b(GuiFancyFlatPresets par0GuiFlatPresets)
    {
