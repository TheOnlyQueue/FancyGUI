...
public class GuiFancySlotLanguage extends GuiFancySlot {
	private ArrayList field_77251_g;
	private TreeMap field_77253_h;

	final GuiFancyLanguage languageGui;

	public GuiFancySlotLanguage(GuiFancyLanguage par1GuiLanguage)
	{
	...
	protected void elementClicked(int par1, boolean par2)
	{
		...
		GuiFancyLanguage.getGameSettings(this.languageGui).language = (String)this.field_77251_g.get(par1);
		this.languageGui.fontRenderer.setBidiFlag(StringTranslate.isBidirectional(GuiFancyLanguage.getGameSettings(this.languageGui).language));
		GuiFancyLanguage.getDoneButton(this.languageGui).displayString = StringTranslate.getInstance().translateKey("gui.done");
		GuiFancyLanguage.getGameSettings(this.languageGui).saveOptions();
	}
