...
public class GuiFancyVideoSettings extends GuiFancyScreen
{
	...
	public GuiFancyVideoSettings(Minecraft mc, GuiScreen oldScreen) {
		super(mc, oldScreen);
    ...
    public void initGui()
    {
        ...
        for (int var12 = 0; var12 < var11; ++var12)
        {
            ...
            {
                this.buttonList.add(new GuiFancySlider(var8.returnEnumOrdinal(), this.width / 2 - 155 + var9 % 2 * 160, this.height / 7 + var4 + 24 * (var9 >> 1), var8, this.guiGameSettings.getKeyBinding(var8), this.guiGameSettings.getOptionFloatValue(var8)));
            }
            else
            {
                this.buttonList.add(new GuiFancySmallButton(var8.returnEnumOrdinal(), this.width / 2 - 155 + var9 % 2 * 160 + 75, this.height / 7 + var4 + 24 * (var9 >> 1), var8, this.guiGameSettings.getKeyBinding(var8), 3));
            }
