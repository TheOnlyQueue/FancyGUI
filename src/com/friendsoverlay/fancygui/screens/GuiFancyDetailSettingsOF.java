...
public class GuiFancyDetailSettingsOF extends GuiFancyScreen {
	...
	public GuiFancyDetailSettingsOF(Minecraft mc, GuiScreen oldScreen) {
		super(mc, oldScreen);
		this.prevScreen = (GuiScreen) getOldValue(0);
		this.settings = (GameSettings) getOldValue(2);
	}
