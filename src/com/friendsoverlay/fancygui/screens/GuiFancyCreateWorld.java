...
public class GuiFancyCreateWorld extends GuiFancyScreen {
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        if (par1GuiButton.enabled)
        {
            ...
            {
                this.mc.displayGuiScreen(new GuiFancyCreateFlatWorld(this, this.field_82290_a));
            }
        }
    }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        if (this.moreOptions)
        {
            ...
            this.drawString(this.fontRenderer, var4.translateKey("selectWorld.mapFeatures.info"), this.width / 2 - 140, 122, 10526880);
