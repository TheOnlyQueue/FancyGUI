...
public class GuiFancyVideoSettingsOF extends GuiFancyScreen {
	...
	public GuiFancyVideoSettingsOF(Minecraft mc, GuiScreen oldScreen) {
		super(mc, oldScreen);
		parentGuiScreen = (GuiScreen) getOldValue(0);
		guiGameSettings = (GameSettings) getOldValue(2);
	}
	...
	public void initGui()
	{
		...
		for (var5 = 0; var5 < var4; ++var5)
		{
			...
			{
				this.buttonList.add(new GuiFancySlider(var6.returnEnumOrdinal(), var7 - 5, var8, var6, this.guiGameSettings.getKeyBinding(var6), this.guiGameSettings.getOptionFloatValue(var6)));
			}
			else
			{
				this.buttonList.add(new GuiFancySmallButton(var6.returnEnumOrdinal(), var7 + 70, var8, var6, this.guiGameSettings.getKeyBinding(var6), 3));
			}
		...
		this.buttonList.add(new GuiFancyButton(101, var7 + 70, var13, "Details...", 3));
		var7 = this.width / 2 - 155 + 160;
		this.buttonList.add(new GuiFancyButton(102, var7 + 70, var13, "Quality...", 3));
		var13 += 21;
		var7 = this.width / 2 - 155 + 0;
		this.buttonList.add(new GuiFancyButton(111, var7 + 70, var13, "Animations...", 3));
		var7 = this.width / 2 - 155 + 160;
		this.buttonList.add(new GuiFancyButton(112, var7 + 70, var13, "Performance...", 3));
		var13 += 21;
		var7 = this.width / 2 - 155 + 0;
		this.buttonList.add(new GuiFancyButton(121, var7 + 70, var13, "Texture Packs...", 3));
		var7 = this.width / 2 - 155 + 160;
		this.buttonList.add(new GuiFancyButton(122, var7 + 70, var13, "Other...", 3));
		this.buttonList.add(new GuiFancyButton(200, this.width / 2, this.height / 6 + 168 + 11, var1.translateKey("gui.done"), 3));
		this.is64bit = false;
	...
	protected void actionPerformed(GuiButton par1GuiButton)
	{
		if (par1GuiButton.enabled)
		{
			...
			{
				this.guiGameSettings.setOptionValue(((GuiFancySmallButton)par1GuiButton).returnEnumOptions(), 1);
	...
	private GuiButton getSelectedButton(int var1, int var2)
	{
		...
		{
			GuiFancyButton var4 = (GuiFancyButton)this.buttonList.get(var3);
