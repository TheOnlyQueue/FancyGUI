...
public class GuiFancyScreenAddServer extends GuiFancyScreen {
	...
	public GuiFancyScreenAddServer(GuiScreen par1GuiScreen, ServerData par2ServerData)
	{
	...
	public void initGui()
	{
		...
		this.buttonList.add(new GuiFancyButton(0, this.width / 2, this.height / 4 + 96 + 12, var1.translateKey("addServer.add"), 3));
		this.buttonList.add(new GuiFancyButton(1, this.width / 2, this.height / 4 + 120 + 12, var1.translateKey("gui.cancel"), 3));
		this.buttonList.add(new GuiFancyButton(2, this.width / 2, 142, var1.translateKey("addServer.hideAddress") + ": " + (this.newServerData.isHidingAddress() ? var1.translateKey("gui.yes") : var1.translateKey("gui.no")), 3));
