...
public class GuiFancySlider extends GuiFancyButton {
	...
	public GuiFancySlider(int par1, int par2, int par3, EnumOptions par4EnumOptions, String par5Str, float par6)
	{
		super(par1, par2 + 75, par3, 100, 20, par5Str, 3);
