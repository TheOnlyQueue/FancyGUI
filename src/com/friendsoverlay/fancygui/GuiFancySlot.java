...
public abstract class GuiFancySlot {
    private final Minecraft mc;

    /**
     * The width of the GuiScreen. Affects the container rendering, but not
     * the overlays.
     */
    private int width;

    /**
     * The height of the GuiScreen. Affects the container rendering, but not
     * the overlays or the scrolling.
     */
    private int height;
     ...
     * down scrolling when over the items and no on scroll bar)
     */
    ...
    public GuiFancySlot(Minecraft par1Minecraft, int par2, int par3,
    ...
    protected abstract void drawSlot(int var1, int var2, int var3,
                                     int var4, Tessellator var5);

    protected void func_77222_a(int par1, int par2,
    ...
    public int func_77210_c(int par1, int par2) {
        ...
        int var5 = par2 - this.top - this.field_77242_t
                + (int) this.amountScrolled - 4;
        int var6 = var5 / this.slotHeight;
        return par1 >= var3 && par1 <= var4 && var6 >= 0 && var5 >= 0
    ...
    /**
     * draws the slot to the screen, pass in mouse's current x and y and
     * partial ticks
     */
    public void drawScreen(int par1, int par2, float par3) {
        ...
        if (Mouse.isButtonDown(0)) {
            if (this.initialClickY == -1.0F) {
                ...
                if (par2 >= this.top && par2 <= this.bottom) {
                    ...
                    var10 = par2 - this.top - this.field_77242_t
                            + (int) this.amountScrolled - 4;
                    var11 = var10 / this.slotHeight;

                    if (par1 >= var8 && par1 <= var9 && var11 >= 0
                            && var10 >= 0 && var11 < var4) {
                        ...
                        this.func_77224_a(par1 - var8, par2 - this.top
                                + (int) this.amountScrolled - 4);
                        var7 = false;
                    }
                ...
                this.amountScrolled -= ((float) par2 - this.initialClickY)
        ...
        for (var11 = 0; var11 < var4; ++var11) {
            ...
            if (var19 <= this.bottom && var19 + var13 >= this.top) {
                if (this.showSelectionBox && this.isSelected(var11)) {
                    ...
                    var18.addVertexWithUV((double) var14, (double) (var19
                            + var13 + 2), 0.0D, 0.0D, 1.0D);
                    var18.addVertexWithUV((double) var15, (double) (var19
                            + var13 + 2), 0.0D, 1.0D, 1.0D);
                    var18.addVertexWithUV((double) var15,
                            (double) (var19 - 2), 0.0D, 1.0D, 0.0D);
                    var18.addVertexWithUV((double) var14,
                            (double) (var19 - 2), 0.0D, 0.0D, 0.0D);
                    var18.setColorOpaque_I(0);
                    var18.addVertexWithUV((double) (var14 + 1),
                            (double) (var19 + var13 + 1), 0.0D, 0.0D, 1.0D);
                    var18.addVertexWithUV((double) (var15 - 1),
                            (double) (var19 + var13 + 1), 0.0D, 1.0D, 1.0D);
                    var18.addVertexWithUV((double) (var15 - 1),
                            (double) (var19 - 1), 0.0D, 1.0D, 0.0D);
                    var18.addVertexWithUV((double) (var14 + 1),
                            (double) (var19 - 1), 0.0D, 0.0D, 0.0D);
                    var18.draw();
        ...
        var18.addVertexWithUV((double) this.left,
                (double) (this.top + var20), 0.0D, 0.0D, 1.0D);
        var18.addVertexWithUV((double) this.right,
                (double) (this.top + var20), 0.0D, 1.0D, 1.0D);
        var18.setColorRGBA_I(0, 255);
        var18.addVertexWithUV((double) this.right, (double) this.top, 0.0D,
                1.0D, 0.0D);
        var18.addVertexWithUV((double) this.left, (double) this.top, 0.0D,
                0.0D, 0.0D);
        var18.draw();
        var18.startDrawingQuads();
        var18.setColorRGBA_I(0, 255);
        var18.addVertexWithUV((double) this.left, (double) this.bottom,
                0.0D, 0.0D, 1.0D);
        var18.addVertexWithUV((double) this.right, (double) this.bottom,
                0.0D, 1.0D, 1.0D);
        var18.setColorRGBA_I(0, 0);
        var18.addVertexWithUV((double) this.right,
                (double) (this.bottom - var20), 0.0D, 1.0D, 0.0D);
        var18.addVertexWithUV((double) this.left,
                (double) (this.bottom - var20), 0.0D, 0.0D, 0.0D);
        var18.draw();
        var19 = this.func_77209_d();
        ...
        if (var19 > 0) {
            ...
            var18.startDrawingQuads();
            var18.setColorRGBA_I(0, 255);
            var18.addVertexWithUV((double) var5, (double) this.bottom,
                    0.0D, 0.0D, 1.0D);
            var18.addVertexWithUV((double) var6, (double) this.bottom,
                    0.0D, 1.0D, 1.0D);
            var18.addVertexWithUV((double) var6, (double) this.top, 0.0D,
                    1.0D, 0.0D);
            var18.addVertexWithUV((double) var5, (double) this.top, 0.0D,
                    0.0D, 0.0D);
            var18.draw();
            var18.startDrawingQuads();
            var18.setColorRGBA_I(8421504, 255);
            var18.addVertexWithUV((double) var5, (double) (var14 + var13),
                    0.0D, 0.0D, 1.0D);
            var18.addVertexWithUV((double) var6, (double) (var14 + var13),
                    0.0D, 1.0D, 1.0D);
            var18.addVertexWithUV((double) var6, (double) var14, 0.0D,
                    1.0D, 0.0D);
            var18.addVertexWithUV((double) var5, (double) var14, 0.0D,
                    0.0D, 0.0D);
            var18.draw();
            var18.startDrawingQuads();
            var18.setColorRGBA_I(12632256, 255);
            var18.addVertexWithUV((double) var5,
                    (double) (var14 + var13 - 1), 0.0D, 0.0D, 1.0D);
            var18.addVertexWithUV((double) (var6 - 1), (double) (var14
                    + var13 - 1), 0.0D, 1.0D, 1.0D);
            var18.addVertexWithUV((double) (var6 - 1), (double) var14,
                    0.0D, 1.0D, 0.0D);
            var18.addVertexWithUV((double) var5, (double) var14, 0.0D,
                    0.0D, 0.0D);
    ...
    private void overlayBackground(int par1, int par2, int par3, int par4) {
        ...
        var5.addVertexWithUV(0.0D, (double) par2, 0.0D, 0.0D,
                (double) ((float) par2 / var6));
        var5.addVertexWithUV((double) this.width, (double) par2, 0.0D,
                (double) ((float) this.width / var6),
                (double) ((float) par2 / var6));
        var5.setColorRGBA_I(4210752, par3);
        var5.addVertexWithUV((double) this.width, (double) par1, 0.0D,
                (double) ((float) this.width / var6),
                (double) ((float) par1 / var6));
        var5.addVertexWithUV(0.0D, (double) par1, 0.0D, 0.0D,
                (double) ((float) par1 / var6));
        var5.draw();
    }
}
